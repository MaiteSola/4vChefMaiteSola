 ...
 */
final class Version20260107125718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingrediente (id INT AUTO_INCREMENT NOT NULL, receta_id INT NOT NULL, nombre VARCHAR(100) NOT NULL, cantidad VARCHAR(50) NOT NULL, unidad VARCHAR(20) NOT NULL, INDEX IDX_BFB4A41E54F853F8 (receta_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paso (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE receta (id INT AUTO_INCREMENT NOT NULL, tipo_id INT NOT NULL, titulo VARCHAR(100) NOT NULL, comensales INT NOT NULL, INDEX IDX_B093494EA9276E6C (tipo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE valoracion (id INT AUTO_INCREMENT NOT NULL, receta_id INT NOT NULL, voto INT NOT NULL, ip VARCHAR(45) NOT NULL, INDEX IDX_6D3DE0F454F853F8 (receta_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
